...
public class UserRegistrationIntegrationTest {
    ...
    void testDuplicateEmailRegistration_Conflict() throws Exception {
        ...
        assertEquals(TEST_FIRST_NAME + " " + TEST_LAST_NAME, originalUser.get().getName(), "Name should remain unchanged");
    }
    ...
    void testMissingFieldsRegistration_BadRequest() throws Exception {
        ...
        missingEmail.put("name", TEST_FIRST_NAME + " " + TEST_LAST_NAME);
        ...
        missingPassword.put("name", TEST_FIRST_NAME + " " + TEST_LAST_NAME);
        ...
        missingRole.put("name", TEST_FIRST_NAME + " " + TEST_LAST_NAME);
        // role is missing
    ...
    void testJwtTokenGeneration_AuthFlow() throws Exception {
        ...
        mockMvc.perform(get("/api/getuser")
                ...
                .andExpect(jsonPath("$.user.name").value(TEST_FIRST_NAME + " " + TEST_LAST_NAME))
    ...
    private Map<String, String> createRegistrationData(String email, String role) {
        ...
        data.put("name", TEST_FIRST_NAME + " " + TEST_LAST_NAME);
        data.put("role", role);
        return data;
    }
